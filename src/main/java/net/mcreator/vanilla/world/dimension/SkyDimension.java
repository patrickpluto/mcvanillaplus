...
import net.mcreator.vanilla.item.SkyItem;
import net.mcreator.vanilla.block.RubyOreBlockBlock;
...
public class SkyDimension extends VanillaModElements.ModElement {
	@ObjectHolder("vanilla_:sky")
	public static final ModDimension dimension = null;
	@ObjectHolder("vanilla_:sky_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public SkyDimension(VanillaModElements instance) {
		super(instance, 57);
	...
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("vanilla_:sky")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("vanilla_:sky"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("vanilla_:sky"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = SkyDimension.CustomPortalBlock.createPatternHelper(entity.world, new BlockPos(pos));
	...
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "sky_portal",
	...
	public static class TeleporterDimensionMod extends Teleporter {
			...
			for (int k7 = -1; k7 < 3; ++k7) {
				for (int j8 = -1; j8 < 4; ++j8) {
					if (k7 == -1 || k7 == 2 || j8 == -1 || j8 == 3) {
						...
						this.world.setBlockState(blockpos$mutable, RubyOreBlockBlock.block.getDefaultState().getBlock().getDefaultState(), 3);
					}
				}
			}
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = SkyDimension.CustomPortalBlock.createPatternHelper(this.world, blockpos);
