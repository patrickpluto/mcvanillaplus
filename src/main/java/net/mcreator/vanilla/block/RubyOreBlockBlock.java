...
public class RubyOreBlockBlock extends VanillaModElements.ModElement {
	@ObjectHolder("vanilla_:ruby_ore_block")
	public static final Block block = null;
	public RubyOreBlockBlock(VanillaModElements instance) {
		super(instance, 37);
	}
